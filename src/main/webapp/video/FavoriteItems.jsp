...
<div class="card bg-dark text-info text-center d-flex col-3 ms-5 me-3 items rounded  mb-3">
<div class="card-header">
Video Tilte: ${item.video.title}
</div>
  <div class="card-body justify-content-center ms-2">
  <a class="" href="WatchVideo.jsp">
  <img style="width: 80%;" src="/AssignmentJava4_Gd1/Images/${item.video.poster}" class="card-img-top" alt="...">
  </a>
  </div>
  <hr>
  <div class="card-footer">
  Thời lượng: ${item.video.duration} phút <br>
  Thể loại:  ${item.video.category} <br> 
